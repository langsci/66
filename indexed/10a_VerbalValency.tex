...
\newcommand{\redesap}[1]{#1} %S, A and P are not glosses, but categories of their own. They should not take quotation marks, neither simple nor double
...
\todo{Frame definitions are now in section titles. Final typesetting postponed until this is OKed}
...
\subsubsection[The double nominative frame]{The double nominative frame: \{A-{\sc nom} P-{\sc nom} V-s[A]\}}\label{itr-teach}
...
\subsubsection[The secundative frame]{The secundative frame: \{A-{\sc erg}  G-{\sc nom} T-{\sc ins} V-a[A].o[G]\}}
...
\subsection[The experiencer-as-possessor frame]{\mbox{The experiencer-as-possessor frame:%
% $\left|
\begin{tabular}{l}
\scriptsize \{S-{\sc gen/nom}  {\sc poss-}N V-s[3]\}    \\
\scriptsize \{A-{\sc gen/erg}  P-{\sc nom} {\sc poss-}N V-a[A].o[3]\}
\end{tabular}
}
% \right|$
}\label{exp}
...
\subsection[Copular and light verb frames]{Copular and light verb frames}\label{cop}

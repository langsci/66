...
\subsubsection[The double nominative frame]{The double nominative frame%
...
\subsubsection[The secundative frame]{The secundative frame %
\mbox{ \{A-{\sc erg}  G-{\sc nom} T-{\sc ins} V-a[A].o[G]\}}}
...
\subsection[The experiencer-as-possessor frame]{\mbox{The experiencer-as-possessor frame} % 
  \mbox{
    \begin{tabular}{l}
      \{S-{\sc gen/nom}  {\sc poss-}N V-s[3]\}    \\
      \{A-{\sc gen/erg}  P-{\sc nom} {\sc poss-}N V-a[A].o[3]\}
    \end{tabular}
  }
} 
\label{exp}

...
\end{table}
\todo{Should ``negation'' that is alone in its row be moved up to the ``converbal'' row where there is no entry in the ``semantics'' column?}

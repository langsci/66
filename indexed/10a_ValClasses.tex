...
\lspbottomrule
\end{tabular}\\
\caption{The effects of the T[\textsc{sap}]→G[3] scenario}\label{t-sap-table}\todo[inline]{I don't think vertical lines are necessary here. If it should resemble a process, I think → between the columns are better for readability}
\end{center}
\end{figure} 

...
\todo[inline]{split table into four smaller tables for easier placement. OK? Typesetting of this chapter postponed till resolution}
\end{table}
...
\caption{Argument realization in infinitival complement constructions}\label{overview-infinitival2}
\end{table}

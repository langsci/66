...
The  verb \emph{niŋsaŋ puŋma} \rede{have enough, lose interest}, an experiencer-as-possessor predicate (cf. §\ref{nv-comp-poss}) may also alternate in valency. In most cases, it is intransitively inflected, invariably with third person singular inflection \Next[a]. With transitive embedded verbs, however, it may optionally mirror the inflection of the embedded verb  \Next[b]. 
